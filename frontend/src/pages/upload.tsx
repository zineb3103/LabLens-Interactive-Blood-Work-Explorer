  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-cyan-50">
      ...
      <div className="max-w-5xl mx-auto px-6 py-12">
            ...
            <div className="flex flex-col items-center space-y-4">
              ...
              {!file ? (
                <>
                  ...
                  <label className="px-6 py-3 bg-gradient-to-r from-cyan-500 to-blue-600 text-white font-semibold rounded-full cursor-pointer hover:scale-105 transition-transform shadow-lg">
                ...
                <>
                  ...
                  <div className="flex space-x-4">
                    <button
                      ...
                      disabled={uploading}
                      className="px-8 py-3 bg-gradient-to-r from-cyan-500 to-blue-600 text-white font-semibold rounded-full hover:scale-105 transition-transform shadow-lg disabled:opacity-50 disabled:cursor-not-allowed flex items-center space-x-2"
                    >
                      {uploading ? (
                        <>
        ...
        {/* Validation Results */}
        {uploadResponse && (
          <div className={`bg-white rounded-2xl shadow-xl p-8 mb-8 border-l-4 ${
            ...
            <div className="flex items-start space-x-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-gray-700 mb-4">{uploadResponse.message}</p>
                ...
                {uploadResponse.errors && uploadResponse.errors.length > 0 && (
                  <div className="mt-4 space-y-2">
                    <h4 className="font-semibold text-red-700">Détails des erreurs:</h4>
                ...
                {uploadResponse.success && (
                  <button
                    ...
                    className="mt-6 px-8 py-3 bg-gradient-to-r from-green-500 to-emerald-600 text-white font-semibold rounded-full hover:scale-105 transition-transform shadow-lg flex items-center space-x-2"
                  >
